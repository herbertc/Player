...
# Generated by qmake (2.01a) (Qt 4.8.4) on: qua set 4 19:17:23 2013
# Project:  Player.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile Player.pro
#############################################################################
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Player1.0.0/ && $(COPY_FILE) --parents player.h .tmp/Player1.0.0/ && $(COPY_FILE) --parents resource.qrc .tmp/Player1.0.0/ && $(COPY_FILE) --parents main.cpp player.cpp .tmp/Player1.0.0/ && $(COPY_FILE) --parents player.ui .tmp/Player1.0.0/ && (cd `dirname .tmp/Player1.0.0` && $(TAR) Player1.0.0.tar Player1.0.0 && $(COMPRESS) Player1.0.0.tar) && $(MOVE) `dirname .tmp/Player1.0.0`/Player1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Player1.0.0
...
moc_player.cpp: player.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) player.h -o moc_player.cpp
...
ui_player.h: player.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic player.ui -o ui_player.h
